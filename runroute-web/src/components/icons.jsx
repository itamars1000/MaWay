// Small inline SVG icons (no icon-font dependency).
...
export function TargetIcon({ size = 22, className }) {
  return (
    <svg
      className={className}
      width={size}
...
export function MapOutlineIcon({ size = 46, className }) {
  return (
    <svg
      className={className}
      width={size}
...
/** Loop / round-trip glyph. */
export function LoopIcon({ size = 19, className }) {
  return (
    <svg
      className={className}
      width={size}
    ...
    >
      ...
      <path d="M3 19v-3.5h3.5" />
    </svg>
  );
}

/** A → B point-to-point glyph. */
export function AbIcon({ size = 20, className }) {
  return (
    <svg
      className={className}
      width={size}
    ...
    >
      ...
      <circle cx="18.5" cy="12" r="2.4" stroke="currentColor" strokeWidth="2" />
      <path
        d="M8.6 12h7"
        stroke="currentColor"
        strokeWidth="2.1"
...
/** Route / path glyph (used on the CTA and stat chip). */
...
/** Bookmark glyph (save). filled toggles the saved state. */
export function BookmarkIcon({ size = 18, filled = false, className }) {
  return (
    <svg
      className={className}
      width={size}
...
/** Up trend glyph (elevation gain / ascent). */
...
/** Down trend glyph (elevation loss / descent). */
...
/** Flag glyph (the A→B end point). */
export function FlagIcon({ size = 20, className }) {
  return (
    <svg
      className={className}
      width={size}
...
/** Gear glyph (settings). */
export function GearIcon({ size = 21, className }) {
  return (
    <svg
      className={className}
      width={size}
    ...
    >
      ...
      <path d="M19.4 13.5a1.7 1.7 0 0 0 .3 1.9l.1.1a2 2 0 1 1-2.8 2.8l-.1-.1a1.7 1.7 0 0 0-2.9 1.2v.1a2 2 0 1 1-4 0v-.1a1.7 1.7 0 0 0-1.1-1.6 1.7 1.7 0 0 0-1.9.4l-.1.1a2 2 0 1 1-2.8-2.8l.1-.1a1.7 1.7 0 0 0-1.2-2.9H3a2 2 0 1 1 0-4h.1a1.7 1.7 0 0 0 1.6-1.1 1.7 1.7 0 0 0-.4-1.9l-.1-.1a2 2 0 1 1 2.8-2.8l.1.1a1.7 1.7 0 0 0 1.9.3H10a1.7 1.7 0 0 0 1-1.6V3a2 2 0 1 1 4 0v.1a1.7 1.7 0 0 0 1 1.6 1.7 1.7 0 0 0 1.9-.3l.1-.1a2 2 0 1 1 2.8 2.8l-.1.1a1.7 1.7 0 0 0-.3 1.9V10a1.7 1.7 0 0 0 1.6 1H21a2 2 0 1 1 0 4h-.1a1.7 1.7 0 0 0-1.5 1z" />
    </svg>
  );
}

/** Chevron (row navigation / back). */
...
export function TurnIcon({ size = 18, className }) {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M6 20V10a4 4 0 0 1 4-4h6" />
      <path d="M13 3l4 3-4 3" />
    </svg>
  );
}
