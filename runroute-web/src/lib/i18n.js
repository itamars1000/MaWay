...
export const TRANSLATIONS = {
  he: {
    ...
    'login.signIn': 'כניסה',
    'login.signUp': 'הרשמה',
    'login.headingSignIn': 'כניסה לחשבון',
    'login.headingSignUp': 'יצירת חשבון',
    'login.orSignIn': '- או התחבר עם -',
    'login.orSignUp': '- או הרשם עם -',
    'login.noAccount': 'אין לך חשבון?',
    'login.haveAccount': 'כבר יש לך חשבון?',
    'login.back': 'חזרה',
  ...
  en: {
    ...
    'login.headingSignIn': 'Login to your Account',
    'login.headingSignUp': 'Create your Account',
    'login.orSignIn': '- Or sign in with -',
