...
export const TRANSLATIONS = {
  he: {
    ...
    'privacy.third': 'קואורדינטות נשלחות למנוע המסלולים, ל-Open-Meteo (נתוני גובה), ל-Photon/OpenStreetMap (חיפוש כתובות) ולספק אריחי המפה. חשבונות ומסלולים נשמרים ב-Supabase.',
  ...
  en: {
    ...
    'privacy.third': 'Coordinates are sent to the route engine, to Open-Meteo (elevation), to Photon/OpenStreetMap (address search), and to the map tile provider. Accounts and saved routes are stored in Supabase.',
